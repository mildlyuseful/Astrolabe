...
def run(*, automated, seconds, controls):
    ...
    report = {
        "mode": "automated_f24" if automated else "interactive_physical",
...
def main():
    ...
    controls = ("f24",) if args.automated else ("ctrl", "shift", "alt", "a", "f12")
    run(automated=args.automated, seconds=args.seconds, controls=controls)
