...
| 5 — Input providers and Windows keyboard | IN_PROGRESS | Start `2aa1c9b`; bootstrap complete | Freeze provider/lifecycle contracts, then implement item 5.1 models and pressed-set aggregation. |
